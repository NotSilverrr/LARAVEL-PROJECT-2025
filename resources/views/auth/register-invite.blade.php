<x-guest-layout>
    <form method="POST" action="{{ route('projects.invitations.register') }}">
        @csrf
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" value="{{ $invitation->email }}" readonly autocomplete="email" />
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ms-4">
                Créer mon compte et rejoindre le projet
            </x-primary-button>
        </div>
    </form>
</x-guest-layout>
