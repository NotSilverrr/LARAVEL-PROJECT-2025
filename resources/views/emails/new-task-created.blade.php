...
<body>
    ...
    <div class="content">
        ...
        <p>Une nouvelle tâche a été créée dans le projet <strong>{{ $project->name }}</strong> et vous y avez été assigné(e).</p>
        ...
        <p>Vous pouvez accéder à cette tâche en vous connectant à votre espace de travail.</p>
